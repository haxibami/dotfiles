...
ZSH_ICON=${ZSH_ICON:-[๑ᴖ◡ᴖ๑]}

# default arrow: ➜

ZSH_ICON_FAIL=${ZSH_ICON_FAIL:-[๑>_<๑]}
...
# }}}
#PROMPT='%(1V:%F{yellow}${DRACULA_ARROW_ICON}:%(?:%F{green}${DRACULA_ARROW_ICON}:%F{red}${DRACULA_ARROW_ICON_FAIL})'

PROMPT='%F{yellow}%~ %F{white}on %F{cyan}%m%

%(1V.%F{yellow}${ZSH_ICON}.%(?.%F{green}${ZSH_ICON}.%F{red}${ZSH_ICON_FAIL}))'
